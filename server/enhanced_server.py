...
# Dynamic import of Fernet
try:
    _cf = importlib.import_module('cryptography.fernet')
    Fernet = _cf.Fernet
    ...
    class Fernet:
        ...
        def decrypt(self, data):
            return data
    print("Warning: cryptography module not available, encryption disabled")
...
ENABLE_ENCRYPTION = ENCRYPTION_AVAILABLE  # Only enable if available
...
class AuthHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        # Simple status page
            ...
            encryption_status = "Enabled" if ENABLE_ENCRYPTION else "Disabled"
            if not ENCRYPTION_AVAILABLE:
                encryption_status += " (cryptography module not installed)"
            
            html = f"""
            <!DOCTYPE html>
            <html>
            <head>
                <title>Backup Server Status</title>
                <style>
            ...
            <body>
                ...
                <div class="status">
                    ...
                    <p><strong>Encryption:</strong> {encryption_status}</p>
